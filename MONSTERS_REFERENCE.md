This work includes material from the System Reference Document 5.2.1 by Wizards of the Coast LLC, available at https://www.dndbeyond.com/srd. The SRD 5.2.1 is licensed under CC BY 4.0, https://creativecommons.org/licenses/by/4.0/legalcode.

# Page 254

Monsters Elementals
Fey are beings from the Elemental Planes,
Stat Block Overview such as efreet and water elementals.
Fien adrse creatures tied to the Feywild or the forces
of nature, such as dryads and goblins.
Giants are creatures tied to terrifying Lower
...
Name and General Details. Human aoried tsowering beings with humanlike shapes,
vided into the following parts:
like fire giants and trolls.
The name of the mon- are people defined by their roles and
Cosmtebr aist fHoillgohwliegdh btsy. its size, creature type (along Mpornosftersossioitnise,s such as mages, pirates, and warriors.
with any descriptive tags), and alignment. They include members of varied species.
Ability Scores. Armor Class, Hit Points, Speed, Oozes are unnatural creatures with
and Initiative are provided here. strange origins, such as mimics and owlbears.
Other Details. A monster’s ability scores, ability Plants are gelatinous creatures, including black
modifiers, and saving throws are listed here. puddings and gelatinous cubes.
The monster’s Senses, Languages, Undea dare sentient vegetation and fungal monsters,
and CR entries appear here. Additional details ap- such as shambling mounds and treants.
pear in some monsters, such as skill proficiencies, are spirits and the reanimated dead, such
Descriptive Tags
TrRaeistiss.tances, Immunities, and Gear. If a monster as ghosts, vampires, and zombies.
lacks those details, entries for them don’t appear.
Actions M. onster characteristics that are active at all
...
Bonus AcTthioen ms.onster can take the actions here in
categorization and have no rules of their own, but
addition to those in “Playing the Game.” Alignment
certain game effects might refer to them.
Reactions and L Tehgiesn sdecatriyo nA pctrioovnidse.s a monster’s
Bonus Actions, if any.
These sections
Parts of a Stat Block The alignment specified in a monster’s stat block is
...
Size suit your storytelling needs. The Neutral alignment,
sary”and in this section.
...
“Character Creation”describes the nine align-
or Gargantuan. If size options are presented, you Armor Class
...
Each monster has a tag that identifies the type of Initiative
...
Beasts are utterly alien beings, such as abo- roll to determine a monster’s Initiative. A monster’s
leths and cloakers. Initiative modifier is typically equal to its Dexterity
Celesti aalrse non-Humanoid natural creatures, like modifier, but some monsters have additional mod-
horses and wolves, as well as most giant animals. ifiers, such as Proficiency Bonus, applied to that
Construct sare magical creatures, such as angels and number.
pegasi, with ties to the Upper Planes. If you don’t want to roll a monster’s Initiative, use
Dragons are magically created creatures such as the In.i”tiative score as the monster’s Initiative in
homunculi and shield guardians. combat. Initiative is further detailed in “Playing the
are scaly beings of ancient origin, such as Game
...
has a Constitution of 12 (+1 modifier) and 2d8 H.”it Monsters have proficiency with their equipment. If
...
monsters have one or more of the followin.”g speeds: ment” for that item. When used by someone else, a
Burrow, Climb, Fly, Swim. Rules for Speed and these retrievable item uses its “Equipment” rules, ignor-
s A pe b c i i l a i l t s y s p S ee c d o s r a e pp s ear in “Rules Glossary ing any special flourishes in the stat block.
...
Skills considered to be supernatural or highly specialized,
...
ciencies, if any. For example, a monster that is very Equipping a Monster with Other Items
...
Senses
member of that class for Attunement purposes. 12 8,400 29 135,000
13 10,000 30 155,000
The Senses entry specifies a monster’s Passive Proficiency Bonus
Perception score, as well as any special .s”enses the
...
to communicate. Sometimes a monster can under- sPtreorf’si ceixecnecpyti oBnoanl uaps tbityu dCeh ias lale fnacgteo rR.ating
...
5–8 +3 21–24 +7
9–12 +4 25–28 +8
Telepathy is a magical ability that allows a cre ature
13–16 +5 29–30 +9
...
is worth is based on its CR, as detailed in the Ex- d A e t s t c a ri c b k e d N in o “ t P a l t a i y o i n ng the Game.”
...
tEhxep XePr ineontceed iPno iitns tsst abty b lCochka.llenge Rating and what happens on a hit. An attack is against one
target unless its entry says otherwise. For details
CR XP CR XP
onH ditif.ferent kinds of attacks, see “Playing the Game”
0 0 or 10 14 11,500
and “Spells.”
1/8 25 15 13,000 AnyH diat:mage dealt or other effects that occur
1/4 50 16 15,000 asM ai rsess.ult of an attack hitting a target are described
1/2 100 17 18,000 after the “ ” notation. Miss:
Hit or I Mf ainss a.ttack has an effect that occurs on a
1 200 18 20,000
miss, that information follows the “ ” notation.
2 450 19 22,000 If an attack has Hanit eofrf eMcits st:hat occurs
3 700 20 25,000 regardless of whether it hits or misses its target,
Saving Throw Effect Notation
that information follows the “ ” notation.
4 1,100 21 33,000
5 1,800 22 41,000
...
8 3,900 25 75,000 the save, and an explanation of what happens on a
9 5,000 26 90,000 failed or successful save.
...
ample, an attack might deal 4 (1d4 + 2) damage on a Legendary Actions
...
t S ie p s e i l t l c ca a n s t u i s n e g , as part of the Attack action. ary Action if it has the Incapacitated condition or is
...
level and can’t be cast at a higher level. Invisi- Some parts of a stat block have restrictions on the
b ilAit my onster’s spell can have special rules or restric- number of times they can be used. Here are the
tions. For example, a green hag can cast the m X/ o D st a c y o . mmon ways that usage is limited:
Spe sllp Ceollm, bpuotn tehne tssp.ell has a “self only” restriction,
...
Retackheanr goen cXe– Ya.nd that the monster must finish a
Long Rest to take it again.
chCaarsatcitnegrs T tihmaet sit o ifs 1c+a sMtiinngu ate ssp.ell. A monster that
...
Bonus Action “Recharge 5–6” in an action means a monster can
cast the spell, as described in “Rules Glossary.”
take the action once. Then, at the start of each of
Rethche amrognes ateftre’sr tau rSnhso, ritt roerg Laoinnsg t Rhee suts.e of that ac-
...
MOD SAVE MOD SAVE MOD SAVE the grapple ends, the target has the Blinded and Re-
...
Assassin MOD SAVE MOD SAVE MOD SAVE
...
80/320 ft. Hit: 8 (1d8 + 4) Piercing damage plus 21 Axe Beak
(6d6) Poison damage.
Large Monstrosity, Unaligned
Bonus Actions
...
Awakened Plants MOD SAVE MOD SAVE MOD SAVE
Str 14 +2 +2 Dex 12 +1 +1 Con 12 +1 +1
Awakened Shrub Int 2 −4 −4 WIS 10 +0 +0 Cha 5 −3 −3
...
Hit: 8 (1d10 + 3) Bludgeoning damage plus 3 (1d6) Bandits
Fire damage.
Bandit
Balor
...
Languages Infernal; telepathy 120 ft. Bearded Devil
CR 5 (XP 1,800; PB +3)
Bearded Devil
Traits
Medium Fiend (Devil), Lawful Evil
...
Points at the start of each of its turns. The wound closes Berserker
...
MOD SAVE MOD SAVE MOD SAVE Adult Black Dragon
...
Rend. Melee Attack Roll: +4, reach 5 ft. Hit: 5 (1d6 + 2) Traits
...
Immunities Acid MOD SAVE MOD SAVE MOD SAVE
...
MOD SAVE MOD SAVE MOD SAVE Immunities Lightning
...
MOD SAVE MOD SAVE MOD SAVE
Str 29 +9 +9 Dex 10 +0 +7 Con 27 +8 +8 MOD SAVE MOD SAVE MOD SAVE
...
MOD SAVE MOD SAVE MOD SAVE effect ends for the target if it takes damage or a creature
...
MOD SAVE MOD SAVE MOD SAVE DC 18, each creature in a 60-foot-long, 5-foot-
...
next turn.
+6
Immunities Fire Bronze Dragons
Senses Blindsight 60 ft., Darkvision 120 ft.;
...
MOD SAVE MOD SAVE MOD SAVE + 7) Slashing damage plus 5 (1d10) Lightning damage.
...
dition until the end of its next turn.
Senses Blindsight 60 ft., Darkvision 120 ft.;
Passive Perception 27 Bugbears
Languages Common, Draconic
...
Large Monstrosity, Unaligned Bonus Actions
...
MOD SAVE MOD SAVE MOD SAVE creatures. Each creature whose space the centaur en-
...
Skills Perception +6
Senses Darkvision 60 ft., Tremorsense 120 ft.; Chain Devil
Passive Perception 16
Languages None Chain Devil
CR 5 (XP 1,800; PB +3)
Medium Fiend (Devil), Lawful Evil
Actions
...
Frightened condition until the end of its turn. Success: Traits
...
Paralyzing Tentacles. Constitution Saving Throw: DC Cloaker
...
MOD SAVE MOD SAVE MOD SAVE Languages Deep Speech, Undercommon
...
Senses Passive Perception 21 Commoner
...
MOD SAVE MOD SAVE MOD SAVE Immunities Acid
...
MOD SAVE MOD SAVE MOD SAVE Rend. Melee Attack Roll: +11, reach 10 ft. Hit: 17 (2d10
...
roll, it covers the target, which has the Blinded condi- MOD SAVE MOD SAVE MOD SAVE
...
Actions Divine Aid (2/Day). The deva casts Cure Wounds,
...
MOD SAVE MOD SAVE MOD SAVE 13 (3d6 + 3) Poison damage.
...
MOD SAVE MOD SAVE MOD SAVE (1d6 + 4) Piercing damage.
...
Verdant Wisp. Ranged Attack Roll: +5, range 90 ft. Hit: Earth Elemental
...
Dryad Int 5 −3 −3 WIS 10 +0 +0 Cha 5 −3 −3
...
Rock Launch. Ranged Attack Roll: +8, range 60 ft. Hit: Erinyes
...
MOD SAVE MOD SAVE MOD SAVE Skills Perception +6, Persuasion +8
...
Ettercap MOD SAVE MOD SAVE MOD SAVE
...
the location of any other creature in contact with Fire Elemental
the same web.
Fire Elemental
Actions
Large Elemental, Neutral
...
Speed 30 ft.
its turns while berserk, the golem attacks the nearest
MOD SAVE MOD SAVE MOD SAVE creature it can see. If no creature is near enough to
...
Flesh Golem 4) Bludgeoning damage plus 4 (1d8) Lightning damage.
Frost Giant
Flesh Golem
Frost Giant
...
Hit: 17 (2d10 + 6) Piercing damage plus 7 (2d6) Cold Gargoyle
...
Glabrezu MOD SAVE MOD SAVE MOD SAVE
...
Demonic Restoration. If the glabrezu dies outside the Reactions
...
Senses Darkvision 60 ft.; Passive Perception 9 Gold Dragons
Languages Common, Goblin
...
Bonus Actions Skills Perception +4, Stealth +4
Immunities Fire
Nimble Escape. The goblin takes the Disengage or
Senses Blindsight 10 ft., Darkvision 60 ft.;
Hide action.
...
Throw: DC 15, each creature in a 30-foot Cone. First Green Dragons
Failure: The target has the Restrained condition and
repeats the save at the end of its next turn if it is still Green Dragon Wyrmling
...
MOD SAVE MOD SAVE MOD SAVE Tentacles attack.
...
HP 11 (2d8 + 2)
Speed 30 ft., Climb 30 ft. Guards
MOD SAVE MOD SAVE MOD SAVE
...
HP 136 (16d10 + 48)
Speed 40 ft., Climb 40 ft., Swim 40 ft. Guard Captain
MOD SAVE MOD SAVE MOD SAVE
...
Actions Medium Fiend, Lawful Evil
AC 15 Initiative +1 (11)
...
MOD SAVE MOD SAVE MOD SAVE ft. Hit: 16 (2d10 + 5) Bludgeoning damage, and the
...
Resistances Cold, Fire, Lightning Hippogriff
Immunities Poison; Poisoned
...
MOD SAVE MOD SAVE MOD SAVE homunculus’s next turn. Failure by 5 or More: The tar-
...
Senses Darkvision 60 ft.; Passive Perception 10 Horned Devil
Languages Common, Goblin
...
Searing Fork. Melee Attack Roll: +10, reach 10 ft. Hit: Ice Devil
...
Fire damage since its last turn. The hydra regains 20 Hit Imp
...
no spell components and using Charisma as the spell- Invisible Stalker
casting ability.
...
Actions
Speed 30 ft.
MOD SAVE MOD SAVE MOD SAVE Multiattack. The knight makes two attacks, using
...
Immutable Form. The golem can’t shape-shift. Kobold Warrior
...
less it is killed by a creature under the effects of a Bless Reactions
...
(1d4) Poison damage. Legendary Actions
...
2/Day Each: Fireball (level 4 version), Invisibility Magmin
...
HP 170 (31d8 + 31)
Speed 30 ft. Traits
MOD SAVE MOD SAVE MOD SAVE Death Burst. The magmin explodes when it dies. Dex-
...
Mephits
Traits
Dust Mephit Death Burst. The mephit explodes when it dies. Consti-
...
Death Burst. The mephit explodes when it dies. Dex-
Ice Mephit terity Saving Throw: DC 11, each creature in a 5-foot
...
Merfolk Skirmisher or range 20/60 ft. Hit: 11 (2d6 + 4) Piercing damage.
...
MOD SAVE MOD SAVE MOD SAVE the mummy’s next turn. Success: The target is immune
...
Multiattack. The mummy makes one Rotting Fist Nalfeshnee
or Channel Negative Energy attack, and it uses
Dreadful Glare. Nalfeshnee
...
maximum decreases by 10 (3d6) every 24 hours that MOD SAVE MOD SAVE MOD SAVE
...
MOD SAVE MOD SAVE MOD SAVE Shape-Shift. The hag shape-shifts into a Small or Me-
Str 18 +4 +4 Dex 15 +2 +2 Con 16 +3 +3
...
MOD SAVE MOD SAVE MOD SAVE
Str 11 +0 +0 Dex 12 +1 +1 Con 11 +0 +0 Ogre
...
Exhaustion, Frightened, Grappled, Prone, Restrained MOD SAVE MOD SAVE MOD SAVE
...
maximum decreases by 5 (1d10) and doesn’t return to Phase Spider
normal until the Poisoned condition ends on the target.
Success: The Poisoned condition ends. Phase Spider
...
Pirates creature the pirate can see within 30 feet. Failure: The
target has the Charmed condition until the start of the
Pirate pirate’s next turn.
Reactions
Medium or Small Humanoid, Neutral
...
Int 8 −1 −1 WIS 12 +1 +1 Cha 14 +2 +4 Pit Fiend
...
MOD SAVE MOD SAVE MOD SAVE Planetar
...
MOD SAVE MOD SAVE MOD SAVE Magic, Healing Word, or Lesser Restoration, using the
Str 14 +2 +2 Dex 10 +0 +0 Con 12 +1 +1
same spellcasting ability as Spellcasting.
Int 10 +0 +0 WIS 14 +2 +2 Cha 11 +0 +0
Pseudodragon
Skills Medicine +4, Religion +2
Gear Chain Shirt, Holy Symbol, Mace Pseudodragon
Senses Passive Perception 12
...
Acid damage at the start of each of the worm’s turns. Rakshasa
...
magical effects, and the attack rolls of spells automat- Young Red Dragon
...
body instantly, reviving with all its Hit Points some- MOD SAVE MOD SAVE MOD SAVE
...
MOD SAVE MOD SAVE MOD SAVE
Red Dragon Wyrmling Str 27 +8 +8 Dex 10 +0 +6 Con 25 +7 +7
...
Remorhaz
Pounce. The dragon moves up to half its Speed, and it
makes one Rend attack. Remorhaz
...
Multiattack. The roc makes two Beak attacks. It can Rust Monster
...
Antennae. The rust monster targets one nonmagical Salamander
...
Sahuagin Warrior Emanation originating from the salamander takes 7
(2d6) Fire damage.
Medium Fiend, Lawful Evil
Actions
...
HP 31 (7d8)
Actions Speed 40 ft.
Multiattack. The sahuagin makes two Claw attacks. MOD SAVE MOD SAVE MOD SAVE
...
Shambling Mound Paralyzed, Petrified, Poisoned
Senses Blindsight 10 ft., Darkvision 60 ft.;
...
makes one Rend attack.
Senses Blindsight 60 ft., Darkvision 120 ft.;
Passive Perception 26 Skeletons
Languages Common, Draconic
...
MOD SAVE MOD SAVE MOD SAVE Immunities Poison, Radiant; Charmed, Exhaustion,
...
MOD SAVE MOD SAVE MOD SAVE 10 ft. or range 120 ft. Hit: 22 (4d6 + 8) Slashing damage
...
creature’s turn, the solar can expend a use to take one of Sphinx of Wonder
...
MOD SAVE MOD SAVE MOD SAVE Heart Sight. Charisma Saving Throw: DC 10, one crea-
...
HP 10 (4d4) Stirge
Speed 10 ft., Fly 40 ft.
MOD SAVE MOD SAVE MOD SAVE Stirge
...
MOD SAVE MOD SAVE MOD SAVE Stone Golem
...
CR 7 (XP 2,900; PB +3) Bonus Actions
...
Stone Club. Melee Attack Roll: +9, reach 15 ft. Hit: 22 Storm Giant
...
Vampire +9, reach 5 ft. Hit: 8 (1d8 + 4) Bludgeoning damage
...
+7, reach 5 ft. Hit: 13 (2d8 + 4) Slashing damage. Wererat
Bonus Actions
Wererat
...
Wereboar MOD SAVE MOD SAVE MOD SAVE
Str 10 +0 +0 Dex 16 +3 +3 Con 12 +1 +1
Wereboar Int 11 +0 +0 WIS 10 +0 +0 Cha 8 −1 −1
...
Weretiger MOD SAVE MOD SAVE MOD SAVE
...
tiger-humanoid hybrid or a Large tiger, or it returns to White Dragon Wyrmling
...
MOD SAVE MOD SAVE MOD SAVE Adult White Dragon
...
Senses Blindsight 10 ft., Darkvision 60 ft.;
MOD SAVE MOD SAVE MOD SAVE
Passive Perception 14 Str 22 +6 +6 Dex 10 +0 +5 Con 22 +6 +6
Languages Draconic
...
control at a time.
the end of the target’s next turn. Failure or Success: The
dragon can’t take this action again until the start of its Will-o’-Wisp
next turn.
Will-o’-Wisp
Frightful Presence. The dragon casts Fear, requiring no
...
radius and Dim Light for an additional 20 feet. Worg
...
Wyvern Bite. Melee Attack Roll: +6, reach 5 ft. Hit: 17 (4d6 + 3)
Piercing damage.
